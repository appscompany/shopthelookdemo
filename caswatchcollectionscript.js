...
console.log(url);
    ...
    $(document).ready(function() {
      $("head").append("<link rel='stylesheet' href='https://cdn.jsdelivr.net/gh/cupelapps/shopthelookdemo@1.4.9/caswatchcollectioncss.css' media='screen'>");
        ...
        var _parameter = getParameterByName('testing', url);
          ...
          if(productstring == 'collections')
          {
            ...
            $(document).on("click", '.caf_swatch_childdiv', function(e) {
              ...
              var _handle = swatchdiv.getAttribute('caf-swatch-handle');
              var parentElement = document.getElementById('caf_swatch_' + _handle);
              var allswatches = $(parentElement).find('.caf_swatch_childdiv');
